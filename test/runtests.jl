...
# !!! Main.UserApp is configured as an alias for Main.CameraMapSite and you might encounter it in some tests
using Main.CameraMapSite, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "CameraMapSite tests" begin
  @includetests ARGS
end
